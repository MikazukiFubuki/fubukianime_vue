...
export const constantRouterMap = [
  ...
  { path: '/login', component: () => import('@/views/login'), name: '登录动画系统', hidden: true },
  ...
  // 报表
  {
    ...
    children: [
      ...
      },
      {
        path: 'mainShows',
        name: 'mainShows',
        component: () => import('@/views/table/show/mainShows.vue'),
        meta: { title: '主表展示', icon: 'anime' }
      },
      {
        path: 'favoriteGirlRanks',
        name: 'favoriteGirlRanks',
        component: () => import('@/views/table/show/favoriteGirlRanks.vue'),
        meta: { title: '最爱女主排名', icon: 'rank' }
      }
    ]
  },
  {
    ...
    children: [
      {
        path: 'mainManages',
        name: 'mainManages',
        component: () => import('@/views/table/anime/mainManages.vue'),
        meta: { title: '主表', icon: '番剧' }
      },
      {
        path: 'quarters',
        name: 'quarters',
        component: () => import('@/views/table/anime/quarters.vue'),
        meta: { title: '追番季', icon: 'Quarter' }
      },
      {
        path: 'periods',
        name: 'periods',
        component: () => import('@/views/table/anime/periods.vue'),
        meta: { title: '时期点', icon: 'time' }
      },
      {
        path: 'editions',
        name: 'editions',
        component: () => import('@/views/table/anime/editions.vue'),
        meta: { title: '版本', icon: 'edition' }
      },
      {
        path: 'sources',
        name: 'sources',
        component: () => import('@/views/table/anime/sources.vue'),
        meta: { title: '动画来源', icon: 'star' }
      },
      {
        path: 'layoutTypes',
        name: 'layoutTypes',
        component: () => import('@/views/table/anime/layoutTypes.vue'),
        meta: { title: '形式类型', icon: 'star' }
      },
      {
        path: 'types',
        name: 'types',
        component: () => import('@/views/table/anime/types.vue'),
        meta: { title: '动画类型', icon: 'star' }
      },
      {
        path: 'loves',
        name: 'loves',
        component: () => import('@/views/table/anime/loves.vue'),
        meta: { title: '恋爱类型', icon: 'star' }
      },
      {
        path: 'sexLimits',
        name: 'sexLimits',
        component: () => import('@/views/table/anime/sexLimits.vue'),
        meta: { title: '工口类型', icon: 'star' }
      },
      {
        path: 'creates',
        name: 'creates',
        component: () => import('@/views/table/anime/creates.vue'),
        meta: { title: '创作类型', icon: 'star' }
      },
      {
        path: 'leaderGenders',
        name: 'leaderGenders',
        component: () => import('@/views/table/anime/leaderGenders.vue'),
        meta: { title: '主角类型', icon: 'star' }
      },
      {
        path: 'animationEnds',
        name: 'animationEnds',
        component: () => import('@/views/table/anime/animationEnds.vue'),
        meta: { title: '动画结局', icon: 'star' }
      },
      {
        path: 'originalEnds',
        name: 'originalEnds',
        component: () => import('@/views/table/anime/originalEnds.vue'),
        meta: { title: '原作结局', icon: 'star' }
      },
      {
        path: 'bingeWatchingTypes',
        name: 'bingeWatchingTypes',
        component: () => import('@/views/table/anime/bingeWatchingTypes.vue'),
        meta: { title: '追番类型', icon: 'star' }
      },
      {
        path: 'merchs',
        name: 'merchs',
        component: () => import('@/views/table/anime/merchs.vue'),
        meta: { title: '动画周边', icon: 'merchant' }
      }
      // {
      //   path: 'TreeTable',
      //   name: 'TreeTable',
    ...
    children: [
      {
        path: 'cvCVs',
        name: 'cvCVs',
        component: () => import('@/views/table/CV/cvCVs.vue'),
        meta: { title: '声优信息', icon: '选择声优' }
      },
      {
        path: 'cvWorks',
        name: 'cvWorks',
        component: () => import('@/views/table/CV/cvWorks.vue'),
        meta: { title: '声优作品', icon: '作品' }
      },
      {
        path: 'cvDeaths',
        name: 'cvDeaths',
        component: () => import('@/views/table/CV/cvDeaths.vue'),
        meta: { title: '已故声优', icon: '选择声优2' }
      }
    ]
  },
  {
    ...
    children: [
      {
        path: 'galgames',
        name: 'galgames',
        component: () => import('@/views/table/GalGame/galgames.vue'),
        meta: { title: 'GalGame', icon: 'game' }
      },
      {
        path: 'ggEnvTypes',
        name: 'ggEnvTypes',
        component: () => import('@/views/table/GalGame/ggEnvTypes.vue'),
        meta: { title: '环境类型', icon: 'star' }
      },
      {
        path: 'ggTypes',
        name: 'ggTypes',
        component: () => import('@/views/table/GalGame/ggTypes.vue'),
        meta: { title: '剧情类型', icon: 'star' }
      },
      {
        path: 'ggRebornTypes',
        name: 'ggRebornTypes',
        component: () => import('@/views/table/GalGame/ggRebornTypes.vue'),
        meta: { title: '轮回类型', icon: 'star' }
      },
      {
        path: 'ggLoveTypes',
        name: 'ggLoveTypes',
        component: () => import('@/views/table/GalGame/ggLoveTypes.vue'),
        meta: { title: '恋爱类型', icon: 'star' }
      },
      {
        path: 'ggBranchTypes',
        name: 'ggBranchTypes',
        component: () => import('@/views/table/GalGame/ggBranchTypes.vue'),
        meta: { title: '分支类型', icon: 'star' }
      },
      {
        path: 'ggSpTypes',
        name: 'ggSpTypes',
        component: () => import('@/views/table/GalGame/ggSpTypes.vue'),
        meta: { title: '特殊类型', icon: 'star' }
      }
    ]
  },
  {
    ...
    children: [
      {
        path: 'musics',
        name: 'musics',
        component: () => import('@/views/table/AniSong/musics.vue'),
        meta: { title: '音乐', icon: 'music' }
      },
      {
        path: 'mTypes',
        name: 'mTypes',
        component: () => import('@/views/table/AniSong/mTypes.vue'),
        meta: { title: '音乐类型', icon: 'star' }
      },
      {
        path: 'mDTypes',
        name: 'mDTypes',
        component: () => import('@/views/table/AniSong/mDTypes.vue'),
        meta: { title: '下载类型', icon: 'star' }
      },
      {
        path: 'mATypes',
        name: 'mATypes',
        component: () => import('@/views/table/AniSong/mATypes.vue'),
        meta: { title: '添加类型', icon: 'star' }
      },
      {
        path: 'mEditions',
        name: 'mEditions',
        component: () => import('@/views/table/AniSong/mEditions.vue'),
        meta: { title: '版本', icon: 'edition' }
      }
    ]
  },
    ...
    children: [
      {
        path: 'hanimes',
        name: 'hanimes',
        component: () => import('@/views/table/comic/hanimes.vue'),
        meta: { title: '里番', icon: '资源 65' }
      },
      {
        path: 'htypes',
        name: 'htypes',
        component: () => import('@/views/table/comic/htypes.vue'),
        meta: { title: 'H漫类型', icon: 'star' }
      },
      {
        path: 'comics',
        name: 'comics',
        component: () => import('@/views/table/comic/comics.vue'),
        meta: { title: '漫画', icon: '漫画2' }
      }
    ]
  }
  // 图表
