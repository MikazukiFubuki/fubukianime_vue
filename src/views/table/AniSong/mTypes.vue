<template>
  <section class="app-container">
    <!--搜索栏-->
    <el-input v-model="pagination.type" placeholder="音乐类型" style="width: 200px;" class="filter-item" />
    ...
    <el-table size="big" current-row-key="id" :data="dataList" stripe highlight-current-row>
      ...
      <el-table-column prop="type" label="音乐类型" align="center" />
    ...
    <!--新增表单-->
    <el-dialog title="新增音乐类型" :visible.sync="dialogFormVisible">
    ...
    <!--编辑表单-->
    <el-dialog title="编辑音乐类型" :visible.sync="dialogFormVisible4Edit">
